...
class AppRouter {
  ...
  final GlobalKey<NavigatorState> _partnerShellKey =
        ...
        routes: [
          ...
          GoRoute(
            ...
            redirect: (context, state) {
              if (state.matchedLocation == RoutePaths.auth) {
            ...
            routes: [
              ...
              GoRoute(
                ...
                name: 'otp',
                builder: (context, state) =>
                    const _PlaceholderPage(title: 'OTP Verification'),
              ),
            ],
          ),
          ...
          ShellRoute(
            ...
            routes: [
              ...
              GoRoute(
                ...
                name: 'gyms',
                redirect: (context, state) {
                  if (state.matchedLocation == RoutePaths.gyms) {
                ...
                routes: [
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) {
                      ...
                      return _PlaceholderPage(title: 'Gym Detail: $gymId');
                    },
                  ),
                  GoRoute(
                    path: 'filter',
              ...
              GoRoute(
                ...
                name: 'subscriptions',
                redirect: (context, state) {
                  if (state.matchedLocation == RoutePaths.subscriptions) {
              ...
              GoRoute(
                ...
                name: 'rewards',
                redirect: (context, state) {
                  if (state.matchedLocation == RoutePaths.rewards) {
  ...
  Future<String?> _handleRedirect(
    ...
    // Skip redirect for auth and onboarding routes
    ...
    if (location.startsWith(RoutePaths.admin)) {
      final roleRedirect = await roleGuard.canActivate(
        context,
        location,
        [UserRole.admin],
      );
